<?php 
	...
	$smarty->assign('style','css/Contacts.css');
	$smarty->display($BASE_DIR .'templates/common/header.tpl'); ?>

            <!-- Page Content -->
            <div class="container">
                <div class="row">
                    <div class="col-md-offset-1 col-md-5 col-lg-offset-1 col-lg-5 col-sm-12 col-xs-12">
                            ...
                            <div class="panel-body">
                                <form>
                                    <div class="form-group">
                                        <strong>Your name:</strong> <small>(required)</small></label>
                                        <input type="name" class="form-control" id="name">
                                    </div>
                                    <div class="form-group">
                                        <strong>Your email:</strong> <small>(required)</small></label>
                                    ...
                                    <a href="#" class="pull-right"><i class="fa fa-envelope-o" aria-hidden="true"></i></a>
                                </form>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-offset-1 col-md-4 col-lg-offset-1 col-lg-4 col-sm-12 col-xs-12">
                        <div class="contacts">
                            ...
                            <address>
                                ...
                                1355 Avenia da Boavista, 900<br>
                                PORTO, PT 94103<br>
