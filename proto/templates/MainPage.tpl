        ...
        <div class="col-md-12">
            ...
            <div id="BestSellers" class="row">
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail">
                        <img src="{$BASE_URL}images/FirstProduct.jpeg" alt="">
                        <div class="caption">
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail">
                        <img src="{$BASE_URL}images/SecondProduct.jpg" alt="">
                        <div class="caption">
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail">
                        <img src="{$BASE_URL}images/ThirdProduct.jpg" alt="">
                        <div class="caption">
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail">
                        <img src="{$BASE_URL}images/ForthProduct.jpg" alt="">
                        <div class="caption">
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail">
                        <img src="{$BASE_URL}images/FifthProduct.jpg" alt="">
                        <div class="caption">
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail">
                        <img src="{$BASE_URL}images/SixthProduct.jpg" alt="">
                        <div class="caption">
